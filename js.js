...
function build_results_table(weeks, results, teams) {
	...
	for (var i=0; i < results.length; i++) {
		...
		for (var k=0; k <results[i].length; k++) {
			...
			if( results[i][k][0] === 1 ) {
				...
				team_win_loss[blue_team][1] = parseInt(team_win_loss[blue_team][1], 10) + 1 ;
				// add lose to second team
				team_win_loss[purple_team][2] = parseInt(team_win_loss[purple_team][2], 10) + 1 ;
			}

			// Purple side wins
			else if ( results[i][k][0] === 0 ) {
				// add win to second team
				team_win_loss[purple_team][1] = parseInt(team_win_loss[purple_team][1], 10) + 1 ;
				// add lose to first team
				team_win_loss[blue_team][2] = parseInt(team_win_loss[blue_team][2], 10) + 1 ;
			}
	...
	// Where the magic sorting happens (this was HARD)
